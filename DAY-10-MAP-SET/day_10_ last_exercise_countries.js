...
let onlyLang = [];
languages = countries.map(({ languages }) => onlyLang.push(...languages));
// console.log(onlyLang);
const langSet = new Set(onlyLang);
console.log(langSet.size);

let mostSpoken = [];
let countedLang = {};
for (let item of langSet) {
  let filtered = onlyLang.filter((lang) => lang == item);
  mostSpoken.push({ [item]: filtered.length });
}
// console.log(mostSpoken);
mostSpoken.sort((a, b) => Object.values(b) - Object.values(a));

// console.log(mostSpoken);

const mostspokenLang = (array, number) => array.slice(0, number);
console.log(mostspokenLang(mostSpoken, 10));
console.log(mostspokenLang(mostSpoken, 3));
